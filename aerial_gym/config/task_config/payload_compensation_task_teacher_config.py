class task_config:
    ...
    reward_parameters = {
        ...
        "angvel_penalty_coef": 1.00,  # xadapt: -0.2 (roll/pitch/yaw各0.2)
        "action_smoothness_coef": 2.0,  # xadapt: -0.06 (oscillate_coeff)
    ...
    payload_parameters = {
        ...
        "release_start": 100,  # 第一阶段：尽早开始释放任务 (CNN训练阶段可通过 train_cnn_student.py 的 --random_preflight_steps 单独控制)
